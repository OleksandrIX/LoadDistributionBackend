...
@router.post(
    ...
    response_description="Created in the cookies refresh_token"
)
...
async def refresh_token(request: Request, uow: UOWDependencies) -> TokenSchema:
...
@router.delete(
    path="/logout",
    status_code=204,
    response_description="Deleted from the cookies refresh_token"
)
